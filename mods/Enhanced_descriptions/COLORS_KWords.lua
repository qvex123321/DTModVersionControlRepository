...
return {
	Bleed_rgb = Bleed_rgb, Bleeding_rgb = Bleeding_rgb, Brittleness_rgb = Brittleness_rgb, Burn_rgb = Burn_rgb, Burning_rgb = Burning_rgb, Heat_rgb = Heat_rgb, Ability_cd_rgb = Ability_cd_rgb, Cd_rgb = Cd_rgb, Combat_ability_rgb = Combat_ability_rgb, Combat_ability_cd_rgb = Combat_ability_cd_rgb, Corruption_rgb = Corruption_rgb, Corruptdmg_rgb = Corruptdmg_rgb, Cleave_rgb = Cleave_rgb, Cleaving_rgb = Cleaving_rgb, Crt_chance_rgb = Crt_chance_rgb, Crit_chance_rgb = Crit_chance_rgb, Crit_hit_rgb = Crit_hit_rgb, Crit_hit_chance_rgb = Crit_hit_chance_rgb, Crit_hits_rgb = Crit_hits_rgb, Crit_rgb = Crit_rgb, Crit0_rgb = Crit0_rgb, Crit_dmg_r_rgb = Crit_dmg_r_rgb, Crit_chance_r_rgb = Crit_chance_r_rgb, Crit_strike_rgb = Crit_strike_rgb, Crit_hit_color_rgb = Crit_hit_color_rgb, Damage_rgb = Damage_rgb, Damagewrp_rgb = Damagewrp_rgb, Damage_ru_rgb = Damage_ru_rgb, Damagewrp_ru_rgb = Damagewrp_ru_rgb, Electrocute_rgb = Electrocute_rgb, Electrocution_rgb = Electrocution_rgb, Electrocuted_rgb = Electrocuted_rgb, Electrocutes_rgb = Electrocutes_rgb, Electrcuting_rgb = Electrcuting_rgb, Feel_no_pain_rgb = Feel_no_pain_rgb, Finesse_rgb = Finesse_rgb, Finesse_dmg_rgb = Finesse_dmg_rgb, Focus_rgb = Focus_rgb, Focus_Target_rgb = Focus_Target_rgb, Fury_rgb = Fury_rgb, Health_rgb = Health_rgb, Wound_rgb = Wound_rgb, Wounds_rgb = Wounds_rgb, Hit_mass_rgb = Hit_mass_rgb, Impact_rgb = Impact_rgb, Lucky_bullet_rgb = Lucky_bullet_rgb, Meleespec_rgb = Meleespec_rgb, Momentum_rgb = Momentum_rgb, Peril_rgb = Peril_rgb, Perils_rgb = Perils_rgb, Power_rgb = Power_rgb, Precision_rgb = Precision_rgb, Rangedspec_rgb = Rangedspec_rgb, Rending_rgb = Rending_rgb, Soulblaze_rgb = Soulblaze_rgb, Stagger_rgb = Stagger_rgb, Staggering_rgb = Staggering_rgb, Staggers_rgb = Staggers_rgb, Stun_rgb = Stun_rgb, Stuns_rgb = Stuns_rgb, Stunned_rgb = Stunned_rgb, Staggered_rgb = Staggered_rgb, Stamina_rgb = Stamina_rgb, Stamina_c_r_rgb = Stamina_c_r_rgb, Stealth_rgb = Stealth_rgb, Strength_rgb = Strength_rgb, Toughness_rgb = Toughness_rgb, Toughness_dmg_red_rgb = Toughness_dmg_red_rgb, Trample_rgb = Trample_rgb, Weakspot_rgb = Weakspot_rgb, Weakspothit_rgb = Weakspothit_rgb, Weakspothits_rgb = Weakspothits_rgb, Weakspot_dmg_rgb = Weakspot_dmg_rgb, Trauma_note_rgb = Trauma_note_rgb, Fns_note_rgb = Fns_note_rgb, Pwr_note_rgb = Pwr_note_rgb, Rend_note_rgb = Rend_note_rgb, Brtl_note_rgb = Brtl_note_rgb, Fire_n_trap_note_rgb = Fire_n_trap_note_rgb,

	scriers_gaze_rgb = scriers_gaze_rgb, stun_gren_rgb = stun_gren_rgb, p_stam_var_rgb = p_stam_var_rgb, p_rbc_rgb = p_rbc_rgb, m_tghn_reg_del_rgb = m_tghn_reg_del_rgb, ammo_var_rgb = ammo_var_rgb, blck_var_rgb = blck_var_rgb, blltam_var_rgb = blltam_var_rgb, chnc_var_rgb = chnc_var_rgb, chrgtime_var_rgb = chrgtime_var_rgb, cd_var_rgb = cd_var_rgb, cleave_var_rgb = cleave_var_rgb, crit_var_rgb = crit_var_rgb, critchmax_var_rgb = critchmax_var_rgb, dmg_var_rgb = dmg_var_rgb, dur_var_rgb = dur_var_rgb, hit_var_rgb = hit_var_rgb, impact_var_rgb = impact_var_rgb, maxstks_var_rgb = maxstks_var_rgb, mult_hit_var_rgb = mult_hit_var_rgb, procch_var_rgb = procch_var_rgb, red_var_rgb = red_var_rgb, rending2_var_rgb = rending2_var_rgb, range_var_rgb = range_var_rgb, rangcrtdmg_var_rgb = rangcrtdmg_var_rgb, rend_var_rgb = rend_var_rgb, stacks_var_rgb = stacks_var_rgb, stgr_var_rgb = stgr_var_rgb, stgrrang_var_rgb = stgrrang_var_rgb, stgrrdct_var_rgb = stgrrdct_var_rgb, stam_var_rgb = stam_var_rgb, time_var_rgb = time_var_rgb, tghns_var_rgb = tghns_var_rgb, value_var_rgb = value_var_rgb, warpchrg_var_rgb = warpchrg_var_rgb, weapsprd_var_rgb = weapsprd_var_rgb,
}
