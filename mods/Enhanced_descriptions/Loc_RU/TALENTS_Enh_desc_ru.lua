...
-- If you can't shorten it, you can simply hide the least useful line by adding Arrow_right_.."-" before that line.
...
local ppp______ppp = "\n+++-------------------------------------------------+++"
local become_invis_drop_all_enemy_aggro_ru = Arrow_right_.." Став невидимым, вы сбрасываете вражеское внимание: враги ближнего боя немедленно переключаются на другую цель, если это возможно, стреляющие враги прекращают стрельбу, затем меняют цель, если это возможно."
local can_be_refr_dur_active_dur_ru = Arrow_right_.." Может быть обновлено во время активности."
local doesnt_stack_aura_psy_ru = Arrow_right_.." Не суммируется с такой же аурой другого псайкера."
local doesnt_interact_w_c_a_r_from_curio_ru = Arrow_right_.." Не взаимодействует с восстановлением боевых способностей от реликвий, которое уменьшает только максимальное время восстановления боевой способности."
local dmg_is_incr_by_ru = Arrow_right_.." Урон увеличивается от пробивания/хрупкости брони, благословения \"Череподробитель\" (при ошеломлении), от боевого стимулятора и усилений от талантов \"Усиленная псионика\", \"Эмпирейское усиление\", \"Эмпирический шок\", \"Прерывание судьбы\", \"Пагубный импульс\", \"Идеальный момент\", \"Взор провидца\" (включая \"Предвидение\"), \"Всадник варпа\", ауры \"Кинетическое присутствие\" (против элиты) и малого узла повышения урона в дальнем бою."
local procs_on_succss_dodging_ru = Arrow_right_.." Срабатывает при успешном уклонении от вражеских атак ближнего или дальнего боя (кроме пулемётчиков, жнецов, снайперов) и от нападений, выводящих из строя (прыжок гончей, сеть ловца, захват мутанта)."
local red_both_tghns_n_health_dmg_ru = Arrow_right_.." Снижает получаемый урон как по стойкости, так и по здоровью."
local stacks_add_w_oth_dmg_ru = Arrow_right_.." Складывается с другими усилениями урона и перемножается с усилениями уровня силы от благословений оружия."
local stacks_mult_w_other_dmg_red_buffs_ru = Arrow_right_.." Эффект перемножается с другими эффектами снижения урона."
local succss_dodge_means_ru = Arrow_right_.." «Успешное уклонение» - уклонение от атак противника, нацеленных на игрока, с помощью вовремя сделанного уклонения или подката."
local warp_attc_refers_to_ru = Arrow_right_.." \"Варп-атака\" относится к списку атак, типы урона которых обозначены как «Типы урона Варпа»: специальные атаки силовых мечей, основные и вторичные атаки психосиловых посохов, электрошок (от «Сокрушения», вторичной атаки электрокинетического посоха, специальной атаки Шоковой кувалды), «Горения души», «Взрыва мозга»/«Разрыва мозга», «Нападения» и «Разрыва варпа»."
local z_eff_of_this_tougn_rep_ru = Arrow_right_.." Эффективность этого восполнения стойкости зависит от некоторых ослаблений игроков, таких как токсичный газ."
local z_ghost_hitnrun_n_stripp_ru = Arrow_right_.." Благословения оружия «Призрак», «Бей и беги» и «Сбросить лишнее» могут активировать этот талант (только против дистанционных атак)."
...
--[+ +BLITZ+ +]--
	...
	local ED_PSY_Blitz_0_rgb_ru = iu_actit(table.concat({
		...
		Arrow_right_.." Базовый урон: 900.",
		-- Arrow_right_.." Всегда поражает в уязвимое место.",
		-- Arrow_right_.." Высокий урон против маньяков и несгибаемых.",
	...
	local ED_PSY_Blitz_1_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		-- Arrow_right_.." Не наносит критические удары.",
		Arrow_right_.." Базовый урон: 1350.",
		-- Arrow_right_.." Всегда поражает в уязвимое место.",
		-- Arrow_right_.." Высокий урон против маньяков и несгибаемых.",
		-- Arrow_right_.." Основная атака применяет к выбранному врагу лёгкий эффект ошеломления на уровне заряда 50%. Не может ошеломить: гренадёров, cкабов-разрубателей, мутантов, огринов, чумных взрывников, берсерков, скабов-штурмовиков или монстров.",
		-- Arrow_right_.." При ударе ошеломляет всех врагов, кроме мутантов, монстров и врагов с активным пустотным щитом.",
		Arrow_right_..dmg_is_incr_by_ru,
	...
	local ED_PSY_Blitz_1_2_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Атаки «Разрыва мозга», вызванные талантом, получают преимущество от усиления урона «Усиленной псионики» без расхода заряда.",
	...
	local ED_PSY_Blitz_2_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Не наносит критические удары.",
		Arrow_right_.." Максимальная дальность: 15 метров.",
		Arrow_right_.." Поражает только в зону туловища.",
		-- Arrow_right_.." Не может ошеломить монстров и врагов с активным пустотным щитом.",
		-- Arrow_right_.."Средний урон по всем видам брони, низкий урон по панцирной броне.",
		dmg_is_incr_by_ru,
		-- Arrow_right_.." Вызывает короткое действие подавления при достижении 100% опасности, снимая ~8,5% опасности. Если отпустить ниже 100% опасности, отталкивает врагов (если это возможно).",
	...
	local ED_PSY_Blitz_2_1_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		-- Arrow_right_.." Увеличивает максимальное количество прыжков с 1 до 2.",
		Arrow_right_.." Применяется и к основным, и к дополнительным атакам.",
		Arrow_right_.." Увеличивает максимальный радиус, в пределах которого «Сокрушение» может поразить другую цель, с 5 до 6 метров.",
		Arrow_right_.." Также увеличивает дальность прицеливания на 1 метр, до 16 метров.",
	}, "\n"), enhdesc_col)

	--[+ Blitz 2-2 - Enfeeble +]--
	local ED_PSY_Blitz_2_2_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		-- Arrow_right_.." Ослабление применяется до тех пор, пока враг находится под действием способности «Сокрушение».",
		Arrow_right_.." Перемножается с другими ослаблениями получаемого урона от таких талантов как «Эмпирический шок» или «Ослабь их», «Отвлекающий манёвр» Огрина, или «Важная цель!» Ветерана, с усилениями урона и уровня силы от благословений оружия.",
		-- Arrow_right_.." Не суммируется с таким же ослаблением, наложенным другим псайкером.",
		Arrow_right_.." Любой источник, который может применить к врагам эффект «Электрошок», не вызовет срабатывания «Ослабления». Работает только для «Сокрушения» или «Заряженного удара». .",
	}, "\n"), enhdesc_col)

	--[+ Blitz 2-3 - Charged Strike +]--
	local ED_PSY_Blitz_2_3_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		-- Arrow_right_.." 8 базового урона за 1 срабатывание.",
		-- Arrow_right_.." Окно повреждений длится до 2 секунд.",
		-- Arrow_right_.." Состояние поражения электрошоком длится в течение 2 секунд после последнего срабатывания урона.",
		Arrow_right_.."- Время до первого срабатывания урона, зависит от ударной массы противника (как и с самим «Сокрушением), поэтому чем больше ударная масса противника, тем больше времени потребуется эффекту электрошока, чтобы нанести урон. В результате против монстров (ударная масса 20), только 1 срабатывание урона может быть выполнено до того, как закончится окно урона в 2 секунды.",
		Arrow_right_.."- Если выбрано «Ослабление», эффект электрошока  фактически удваивает количество его срабатываний. С «Ослаблением» он также выигрывает от 10%-ного увеличения получаемого урона. По-видимому, каждый тик урона добавляет один заряд ослабления, увеличивая урон, который получает ослабленный враг за тик. Все атакующие могут извлечь из этого выгоду, только пока эффект электрошока активно наносит урон и применяет дебафф.",
	}, "\n"), enhdesc_col)

	--[+ Blitz 3 - Assail +]--
	local ED_PSY_Blitz_3_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Может нанести крит. Пробивает до 2 врагов.",
		-- Arrow_right_.." Тратит 1 заряд. Перезаряжается каждые 3 секунды.",
		-- Arrow_right_.." Очень низкий урон против панцирной брони и низкий против несгибаемых.",
		-- Arrow_right_.." Затрагивается усилением снижения набора опасности от соответствующих талантов и боевых стимуляторов.",
		dmg_is_incr_by_ru,
	...
	local ED_PSY_Blitz_3_1_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Если активна «Усиленная псионика», количество пробиваемых целей увеличивается вплоть до 6.",
		Arrow_right_.." Панцирная броня по умолчанию не может быть пробита.",
	}, "\n"), enhdesc_col)

	--[+ Blitz 3-2 - Quick Shards +]--
	local ED_PSY_Blitz_3_2_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Сокращает время перезарядки снарядов с 3 до 2,1 секунды на заряд.",
		Arrow_right_.." Не взаимодействует с мутатором «Улучшенный блиц».",
	}, "\n"), enhdesc_col)
...
--[+ +AURA+ +]--
	...
	local ED_PSY_Aura_0_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		-- Arrow_right_.." Складывается с восстановлением боевых способностей от реликвий и мутаторами миссий, которые сокращают время восстановления способностей на 20%.",
		Arrow_right_.." Это сокращает максимальное время восстановления способностей «Сбрасывающий вопль»/«Гнев психокинетика» до 27.75 секунд, «Взор провидца» до 23.125 секунд, а «Телекинический щит» до 37 секунд.",
		doesnt_stack_aura_psy_ru,
	}, "\n"), enhdesc_col)

	--[+ Aura 1 - Kinetic Presence +]--
	local ED_PSY_Aura_1_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		stacks_add_w_oth_dmg_ru,
		doesnt_stack_aura_psy_ru,
	}, "\n"), enhdesc_col)
	...
	local ED_PSY_Aura_2_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Складывается с восстановлением боевых способностей от реликвий и мутаторами миссий, которые сокращают время восстановления способностей на 20%.",
		Arrow_right_.." Это сокращает максимальное время восстановления способностей «Сбрасывающий вопль»/«Гнев психокинетика» до 27 секунд, «Взор провидца» до 22.5 секунд, а «Телекинический щит» до 36 секунд.",
		doesnt_stack_aura_psy_ru,
	}, "\n"), enhdesc_col)
	...
	local ED_PSY_Aura_3_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Применяется ко всем атакам, которые могут нанести крит.",
		Arrow_right_.." Складывается с другими источниками шанса крита.",
		doesnt_stack_aura_psy_ru,
	}, "\n"), enhdesc_col)
...
--[+ +ABILITIES+ +]--
	...
	local ED_PSY_Ability_0_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Варпа-волна проходит сквозь объекты и распространяется на расстояние до 30 метров, т.ч. вы можете сбросить Гончую с союзника через стену.",
		-- Arrow_right_.." Оглушает врагов в радиусе 5 метров перед псайкером.",
	}, "\n"), enhdesc_col)

	--[+ Ability 1 - Venting Shriek +]--
	local ED_PSY_Ability_1_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Всегда нацелено в зону туловища.",
		Arrow_right_.." Варпа-волна проходит сквозь объекты и распространяется на расстояние до 30 метров, т.ч. вы можете сбросить Гончую с союзника через стену.",
		-- Arrow_right_.." Ошеломляет врагов в радиусе 5 метров перед псайкером.",
		-- Arrow_right_.." Сила ошеломления увеличивается с уровнем опасности, достигая максимальной силы при 100%. Вплоть до лёгкого ошеломления против крушителей. Не может ошеломить мутантов, монстров и врагов с активным пустотным щитом.",
		Arrow_right_.." Не может ошеломить мутантов, монстров и врагов с активным пустотным щитом.",
		Arrow_right_.." Сила ошеломления уменьшается с дальностью, практически полностью теряя свою эффективность на расстоянии 30 метров.",
		Arrow_right_.." На силу ошеломления дополнительно влияют некоторые благословения оружия: «Каратель», «Мясник», «Превосходство», «Нестабильная мощь» и т.д. Применяется только в том случае, если соответствующее оружие экипировано во время крика.",
	}, "\n"), enhdesc_col)

	--[+ Ability 1-1 - Becalming Eruption +]--
	local ED_PSY_Ability_1_1_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Перемножается с соответствующими эффектами снижения набора опасности от талантов «Треск костей», «Эмпирическая решимость», «Внутреннее спокойствие», «Кинетический резонанс», небольших узлов сопротивления опасности и боевых стимуляторов.",
	}, "\n"), enhdesc_col)

	--[+ Ability 1-2 - Warp Rupture +]--
	local ED_PSY_Ability_1_2_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Имеет одинаковый модификатор урона по всем типам брони, теряет урон с расстоянием.",
		Arrow_right_.." Базовый наносимый урон зависит от уровня опасности:",
		"_______________________________",
		"Опасность:  0%| 25%| 50%| 75%| 100%",
		"Урон:            100|  125|  150|  175|  200",
		"_______________________________",
		Arrow_right_.." На урон влияют усиления урона:",
		-- Arrow_right_.."- от талантов: «Прерывание судьбы», «Эмпирейское усиление», «Эмпирический шок» (при ослаблении), «Пагубный импульс», «Кинетическое присутствие» (против элиты), «Идеальный момент» и «Всадник варпа».",
		Arrow_right_.."- от талантов: «Прерывание судьбы», «Эмпирейское усиление», «Эмпирический шок», «Пагубный импульс», «Кинетическое присутствие», «Идеальный момент» и «Всадник варпа».",
		Arrow_right_.."- от благословений оружия. Срабатывает если до активации Разрыва варпа оружие было в руках:",
		-- Arrow_right_.."-- Ближний бой: «Каратель», «Высокое напряжение» (против поражённого током), «Череподробитель» (против ошеломлённых), «Мясник», «Превосходство» и «Нестабильная мощь».",
		Arrow_right_.."-- Ближний бой: «Каратель», «Высокое напряжение», «Череподробитель», «Мясник», «Превосходство» и «Нестабильная мощь».",
		-- Arrow_right_.."-- Дальний бой: «Стрельба без устали», «Непрерывный обстрел», «Смертоплюй», «Дум-дум», «Казнь» (против ошеломлённых), «Неистовая стрельба», «Полный калибр», «Без передышки» (против ошеломлённых), «Подавляющий огонь», «Пороховой ожог» и «Стреляй и беги» (во время бега).",
		Arrow_right_.."-- Дальний бой: «Стрельба без устали», «Непрерывный обстрел», «Смертоплюй», «Дум-дум», «Казнь», «Неистовая стрельба», «Полный калибр», «Без передышки», «Подавляющий огонь», «Пороховой ожог» и «Стреляй и беги».",
	}, "\n"), enhdesc_col)

	--[+ Ability 1-3 - Warp Creeping Flames +]--
	local ED_PSY_Ability_1_3_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Количество зарядов зависит от уровня опасности:",
		"_______________________________",
		"Заряды:              1|    2|    3|     4|    5|    6",
		"Опасность(~%): 0|  17|  34|  50|  67|  84",
		"_______________________________",
		-- Arrow_right_.." Длится 8 секунд. Срабатывает каждые 0.75 секунды.",
		Arrow_right_.." Длительность обновляется при накладывании зарядов.",
		Arrow_right_.." Складывается с другими источниками Горения души.",
		Arrow_right_.." Урон увеличивается от пробивания/хрупкости, характеристик текущего оружия и усилений от Талантов: «Прерывание судьбы», «Пагубный импульс», «Эмпирейское усиление», «Кинетическое присутствие», «Идеальный момент» и «Всадник варпа».",
		-- Arrow_right_.."- Благословений оружия:",
		-- Arrow_right_.."-- Ближний бой: «Каратель», «Высокое напряжение» (против поражённого током), «Череподробитель» (против ошеломлённых), «Мясник», «Превосходство» и «Нестабильная мощь».",
		-- Arrow_right_.."-- Дальний бой: «Стрельба без устали», «Непрерывный обстрел», «Смертоплюй», «Дум-дум», «Казнь» (против ошеломлённых), «Неистовая стрельба», «Полный калибр», «Без передышки» (против ошеломлённых), «Подавляющий огонь», «Пороховой ожог» и «Стреляй и беги» (во время бега).",
		Arrow_right_.."- Благословений ближнего боя: «Превосходство», «Высокое напряжение», «Череподробитель», «Мясник», «Нестабильная мощь», «Каратель» и дальнего боя: «Стрельба без устали», «Дум-дум», «Непрерывный обстрел», «Казнь», «Смертоплюй», «Полный калибр», «Неистовая стрельба», «Пороховой ожог», «Подавляющий огонь», «Без передышки» и «Стреляй и беги».",
	}, "\n"), enhdesc_col)

	--[+ Ability 2 - Telekine Shield +]--
	local ED_PSY_Ability_2_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Здоровье щита: 20.",
		Arrow_right_.." Размеры: ширина 6 метров, высота 3.5 метра.",
		Arrow_right_.." Максимальный радиус действия: 10 метров.",
		Arrow_right_.." Общее время размещения: 0.6 секунды.",
		Arrow_right_.." Вы можете удерживать кнопку «Способности» для предварительного просмотра местоположения и можете отменить установку блоком.",
		Arrow_right_.." Блокирует: дистанционные атаки, снаряды (гранаты), сетки и прямые попадания из огнемёта.",
		Arrow_right_.." Очаги наземного огня и облака токсичных газов распространяются сквозь щит.",
		Arrow_right_.." Не блокирует взрыв Взрывника.",
		Arrow_right_.." Как работает здоровье щита:",
		Arrow_right_.."- Каждая входящая атака дальнего боя наносит 1 единицу урона. После получения урона щит не получает больше урона в течение следующих 0.33 секунд.",
		Arrow_right_.."-- Например, если поместить щит перед пулемётчиком, он растает во время второго залпа, после 20 попаданий.",
	}, "\n"), enhdesc_col)

	--[+ Ability 2-1 - Bolstered Shield +]--
	local ED_PSY_Ability_2_1_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Перезарядка второго заряда начинается только после того, как закончится перезарядка первого.",
	}, "\n"), enhdesc_col)

	--[+ Ability 2-2 - Enervating Threshold +]--
	local ED_PSY_Ability_2_2_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Не наносит урона.",
		Arrow_right_.." Применяет ошеломление каждые 0.55 секунды.",
		Arrow_right_.." Эффект поражения электрическим током длится 3 секунды.",
		Arrow_right_.." Может ошеломить всех врагов, кроме монстров.",
		Arrow_right_.." Эффект всегда применяется к специалистам, когда они соприкасаются со щитом.",
		-- Arrow_right_.." Щит получает 8 урона за каждое прямое попадание от специалистов и исчезает после 3 \"заблокированных\" специалистов. Соблюдает окно восстановления после урона в 0.33 секунды, что означает, что любое количество прямых попаданий в щит от специалистов, которые происходят в течение 0.33 секунд, считаются как 1 прямое попадание.",
		"",
	...
	local ED_PSY_Ability_2_3_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Радиус сферы: 6 метров.",
		Arrow_right_.." Защищает от атак противника со всех сторон.",
		Arrow_right_.." Имеет те же свойства, что и плоский щит.",
		Arrow_right_.." Аналогичным образом получает урон от дальнего боя.",
		"",
	...
	local ED_PSY_Ability_2_4_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Этот эффект пополнения может суммироваться, если несколько сфер перекрывают друг друга.",
		z_eff_of_this_tougn_rep_ru,
		stacks_mult_w_other_dmg_red_buffs_ru,
	}, "\n"), enhdesc_col)

	--[+ Ability 3 - Scrier's Gaze +]--
	local ED_PSY_Ability_3_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		-- Arrow_right_.." Пока способность активирована, перезарядка приостанавливается. Однако её оставшееся время перезарядки всё ещё можно сократить, активировав «Ауру психокинетика» или использовав стимулятор концентрации.",
		-- Arrow_right_.." Его максимальное время восстановления может быть уменьшено с помощью «Присутствия провидца», «Переливания варпа», регенерации боевых способностей от реликвий и мутаторов миссий, уменьшающих на 20% время восстановления способностей.",
		-- Arrow_right_.." После окончания действия способности вы получаете дополнительно 1.5 секунды, в течение которых можно выполнять действия, набирающие опасность, без самоподрыва.",
	}, "\n"), enhdesc_col)

	-- [+ Ability 3-1 - Endurance +]--
	local ED_PSY_Ability_3_1_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Не продлевается после окончания действия способности.",
		stacks_mult_w_other_dmg_red_buffs_ru,
	}, "\n"), enhdesc_col)
	...
	local ED_PSY_Ability_3_2_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Складывается с другими усилениями урона по уязвимым местам от ловкости.",
		Arrow_right_.." Может срабатывать несколько раз за атаку при рассечении нескольких врагов.",
		Arrow_right_.." Эти накапливающиеся усиления урона активируются немедленно во время активации способности.",
	}, "\n"), enhdesc_col)
	...
	local ED_PSY_Ability_3_3_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Не продлевается после окончания действия способности.",
		Arrow_right_.." Эффект суммируется с усилениями скорости движения от «Прерывания судьбы», «Ретивости», малого узла скорости движения и благословений оружия, таких как «Ускорься».",
	}, "\n"), enhdesc_col)
	...
	local ED_PSY_Ability_3_4_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." Не продлевается после окончания действия способности.",
		Arrow_right_.." Перемножается с усилениями снижения набора опасности от «Треска костей», «Эмпирической решимости», «Кинетического резонанса», малых узлов сопротивления опасности и боевых стимуляторов.",
		Arrow_right_.." Может суммироваться с «Внутренним спокойствием», только если псайкер восстанавливает заряды варпа при перегреве.",
	}, "\n"), enhdesc_col)

	--[+ Ability 3-5 - Warp Unbound +]--
	local ED_PSY_Ability_3_5_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		Arrow_right_.." После окончания действия этой способности позволяет псайкеру в течение 10 секунд выполнять действия, набирающие опасность, без самоподрыва даже при 100% опасности.",
		Arrow_right_.." Обратите внимание, что этот модификатор имеет скрытый эффект: по истечении 10 секунд вы получите ещё 1.5 секунды этого же действия.",
	}, "\n"), enhdesc_col)
...
--[+ +KEYSTONES+ +]--
	...
	local ED_PSY_Keystone_1_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		can_be_refr_dur_active_dur_ru,
		-- Arrow_right_.." Взаимодействует с восстановлением боевых способностей от реликвий и другими максимальными сокращениями перезарядки от «Присутствия провидца» или мутаторами миссий, которые сокращают перезарядку способностей на 20%.		Interacts with Combat Ability Regeneration from Curios and other Maximum Cooldown Reductions from \"Seer's Presence\" or the mission mutators that reduce Ability cooldowns by 20%.",
...
--[+ +PASSIVES+ +]--
	...
	local ED_PSY_Passive_1_rgb_ru = iu_actit(table.concat({
		...
		-- Arrow_right_.."- For example, a Psyker with 96 Max Toughness killing two enemies with an activated Force sword attack replenishes 96x(0.1+0.15)=24 Toughness.",
		z_eff_of_this_tougn_rep_ru,
		warp_attc_refers_to_ru,
	}, "\n"), enhdesc_col)
	...
	local ED_PSY_Passive_2_rgb_ru = iu_actit(table.concat({
		...
		-- Arrow_right_.."- Stacks last for 4 seconds.",
		Arrow_right_..""..can_be_refr_dur_active_dur_ru.."",
	...
	local ED_PSY_Passive_5_rgb_ru = iu_actit(table.concat({
		...
		-- Arrow_right_.."- Lasts 8s.",
		-- Arrow_right_.."- Same as other sources of Soulblaze.",
		-- Arrow_right_.."- Ticks every 0.75 seconds.",
		-- Arrow_right_.."- Refreshes duration on stack application.",
		-- Arrow_right_.."- Very high armor Damage modifiers across the board, very low armor Damage modifier against Carapace.",
	...
	local ED_PSY_Passive_8_rgb_ru = iu_actit(table.concat({
		...
		-- Arrow_right_.."- if 4 Stacks and 4 targets - each target receives 1 Stack;",
		-- Arrow_right_.."- if 4 Stacks and 3 targets - 1 target receives 2 Stacks while the other 2 targets receive 1 Stack each, etc.",
	...
	local ED_PSY_Passive_9_rgb_ru = iu_actit(table.concat({
		...
		doesnt_interact_w_c_a_r_from_curio_ru,
	}, "\n"), enhdesc_col)
	...
	local ED_PSY_Passive_26_rgb_ru = iu_actit(table.concat({
		...
		-- Arrow_right_.."- Max radius: 10 meters.",
		-- Arrow_right_.."- Staggers all enemies except for Crusher, Mutants, Monstrosities, Twins (Captains only without void shield).",
		-- Arrow_right_.."- Deals 600 base Damage against all enemies.",
		-- Arrow_right_.."- Explosion Damage decreases from center to Max range and can be increased by Damage buffs from \"Disrupt Destiny\", \"Empyrean Empowerment\", \"Malefic Momentum\" (regular Damage buff), \"Scrier's Gaze\", and \"Warp Rider\".",
	}, "\n"), enhdesc_col)
	...
	local ED_PSY_Passive_30_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		-- Arrow_right_.." While at or above 75% true Peril, grants 10% пробивания to Warp attacks boosting Damage against armor types Carapace, Flak, Maniac, Unyielding.",
		-- Arrow_right_.." Only affects Psyker's own Damage.",
		-- Arrow_right_.." Stacks additively with other пробивания buffs and with хрупкости debuffs that are applied to enemies.",
		warp_attc_refers_to_ru,
	...
	local ED_PSY_Passive_32_rgb_ru = iu_actit(table.concat({
		...
		-- Arrow_right_.." Upon Reload, generates up to 25% Peril based on the percentage of reloaded ammo in clip. ",
...
--[+ +AURA+ +]--
	...
	local ED_ZEA_Ability_1_rgb_ru = iu_actit(table.concat({
		...
		-- Arrow_right_.."- Adds a 100% пробивания against Carapace, Flak, Maniac, Unyielding armor types to the next Melee Attack within 3 seconds after activation.",
	...
	local ED_ZEA_Ability_3_rgb_ru = iu_actit(table.concat({
		-- ppp______ppp,
		become_invis_drop_all_enemy_aggro_ru,
	...
	local ED_ZEA_Ability_3_3_rgb_ru = iu_actit(table.concat({
		...
		red_both_tghns_n_health_dmg_ru,
		stacks_mult_w_other_dmg_red_buffs_ru,
		z_eff_of_this_tougn_rep_ru,
	}, "\n"), enhdesc_col)
...
--[+ +KEYSTONES+ +]--
	...
	local ED_ZEA_Keystone_1_rgb_ru = iu_actit(table.concat({
		...
		-- Arrow_right_.." Длительность действия Ярости можно обновить, убивая врагов.",
	...
	local ED_ZEA_Keystone_3_2_rgb_ru = iu_actit(table.concat({
		...
		succss_dodge_means_ru,
		z_ghost_hitnrun_n_stripp_ru,
		"",
	}, "\n"), enhdesc_col)
...
--[+ +PASSIVES+ +]--
	...
	local ED_ZEA_Passive_29_rgb_ru = iu_actit(table.concat({
		...
		-- Arrow_right_.." Stacks last for 5 seconds.",
		can_be_refr_dur_active_dur_ru,
