...
--[+ +NODES+ +]--
	...
	local ED_CritChncBst_rgb = ""

	--[+ Health Boost Low +]--
	local ED_HeathBst_L_rgb = ""

	--[+ Health Boost Medium +]--
	local ED_HeathBst_M_rgb = ""

	--[+ Heavy Melee Damage Boost Low + Medium +]--
	local ED_HMeleeDmgBst_LM_rgb = ""

	--[+ Inspiring Presence +]--
	local ED_InspiringP_rgb = ""

	--[+ Melee Damage Boost Low + Medium +]--
	local ED_MeleeDmgBst_L_M_rgb = ""

	--[+ Movement Speed Boost +]--
	local ED_MoveSpdBst_rgb = ""

	--[+ Peril Resistance +]--
	local ED_PerilRes_rgb = ""

	--[+ Ranged Damage Boost +]--
	local ED_RangDmgBst_rgb = ""

	--[+ Reload Boost +]--
	local ED_ReloadBst_rgb = ""

	--[+ Rending Boost +]--
	local ED_RendingBst_rgb = ""

	--[+ Stamina Boost +]--
	local ED_StaminaBst_rgb = ""

	--[+ Suppression Boost +]--
	local ED_SuppressionBst_rgb = ""

	--[+ Stamina Regeneration Boost +]--
	local ED_StamRegenBst_rgb = ""

	--[+ Toughness Boost Low +]--
	local ED_TghnsBst_L_rgb = ""

	--[+ Toughness Boost Medium +]--
	local ED_TghnsBst_M_rgb = ""

	--[+ Toughness Damage Reduction Low + Medium +]--
	local ED_TghnsDmgRed_LM_rgb = ""
