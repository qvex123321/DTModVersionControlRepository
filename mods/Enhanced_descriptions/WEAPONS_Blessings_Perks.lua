...
--[+ ++WEAPON - BLESSINGS++ +]--
	...
	create_template("trait_bespoke_074_desc_ext_en", {"loc_trait_bespoke_suppression_on_close_kill_desc"}, {"en"}, function(locale, value) return "Suppress Enemies on Kill at a distance of up to "..COLORS_Numbers.n_12_5_rgb.." meters." end), -- rewrite -- colors 5m->5meters
				-- create_template("trait_bespoke_38_desc_ext_en", {"loc_trait_bespoke_suppression_on_close_kill_desc"}, {"en"}, function(locale, value) return "Suppress Enemies within "..COLORS_Numbers.range_var_rgb.."eters Radius on Kill at a distance of up to "..COLORS_Numbers.n_12_5_rgb.." meters." end), -- range: 7 -- colors 5m->5meters
		--[+ Roaring Advance +]--
	...
	create_template("trait_bespoke_096_desc_ext_en", {"loc_trait_bespoke_double_shot_on_primary_crit_and_crit_chance_desc"}, {"en"}, function(locale, value) return COLORS_Numbers.p_crit_var_rgb.." Ranged "..COLORS_KWords.Crit_chance_rgb..".\n"..COLORS_Numbers.value_var_rgb.." Shots on Primary "..COLORS_KWords.Crit_hit_rgb.."." end), -- crit_chance: +5%, value: 2 -- rewrite -- colors
		--[+ Warp Flurry +]-- 
