...
--[+ +NODES+ +]--
	...
	local ED_CritChncBst_rgb_tw = ""
	--[+ Health Boost Low +]--
	local ED_HeathBst_L_rgb_tw = ""
	--[+ Health Boost Medium +]--
	local ED_HeathBst_M_rgb_tw = ""
	--[+ Heavy Melee Damage Boost Low + Medium +]--
	local ED_HMeleeDmgBst_LM_rgb_tw = ""
	--[+ Inspiring Presence +]--
	local ED_InspiringP_rgb_tw = ""
	--[+ Melee Damage Boost Low + Medium +]--
	local ED_MeleeDmgBst_L_M_rgb_tw = ""
	--[+ Movement Speed Boost +]--
	local ED_MoveSpdBst_rgb_tw = ""
	--[+ Peril Resistance +]--
	local ED_PerilRes_rgb_tw = ""
	--[+ Ranged Damage Boost +]--
	local ED_RangDmgBst_rgb_tw = ""
	--[+ Reload Boost +]--
	local ED_ReloadBst_rgb_tw = ""
	--[+ Rending Boost +]--
	local ED_RendingBst_rgb_tw = ""
	--[+ Stamina Boost +]--
	local ED_StaminaBst_rgb_tw = ""
	--[+ Suppression Boost +]--
	local ED_SuppressionBst_rgb_tw = ""
	--[+ Stamina Regeneration Boost +]--
	local ED_StamRegenBst_rgb_tw = ""
	--[+ Toughness Boost Low +]--
	local ED_TghnsBst_L_rgb_tw = ""
	--[+ Toughness Boost Medium +]--
	local ED_TghnsBst_M_rgb_tw = ""
	--[+ Toughness Damage Reduction Low + Medium +]--
	local ED_TghnsDmgRed_LM_rgb_tw = ""
