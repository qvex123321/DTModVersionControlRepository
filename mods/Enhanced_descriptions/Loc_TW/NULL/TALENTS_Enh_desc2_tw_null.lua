...
--[+ +BLITZ+ +]--
	...
	local ED_VET_Blitz_0_rgb_tw = ""
	--[+ Blitz 1 - Frag Grenade +]--
	local ED_VET_Blitz_1_rgb_tw = ""
	--[+ Blitz 2 - Krak Grenade +]--
	local ED_VET_Blitz_2_rgb_tw = ""
	--[+ Blitz 3 - Smoke Grenade +]--
	local ED_VET_Blitz_3_rgb_tw = ""

--[+ +AURA+ +]--
	--[+ Aura 0 - Scavenger +]--
	local ED_VET_Aura_0_rgb_tw = ""
	--[+ Aura 1 - Survivalist +]--
	local ED_VET_Aura_1_rgb_tw = ""
	--[+ Aura 2 - Fire Team +]--
	local ED_VET_Aura_2_rgb_tw = ""
	--[+ Aura 3 - Close and Kill +]--
	local ED_VET_Aura_3_rgb_tw = ""

--[+ +ABILITIES+ +]--
	--[+ Ability 0 - Volley Fire +]--
	local ED_VET_Ability_0_rgb_tw = ""
	--[+ Ability 1 - Executioner's Stance +]--
	local ED_VET_Ability_1_rgb_tw = ""
	--[+ Ability 1-1 - Enhanced Target Priority +]--
	local ED_VET_Ability_1_1_rgb_tw = ""
	--[+ Ability 1-2 - Counter-Fire +]--
	-- local ED_VET_Ability_1_2_rgb_tw = ""
	--[+ Ability 1-3 - The Bigger they Are... +]--
	-- local ED_VET_Ability_1_3_rgb_tw = ""
	--[+ Ability 1-4 - Marksman +]--
	local ED_VET_Ability_1_4_rgb_tw = ""
	--[+ Ability 2 - Voice of Command +]--
	local ED_VET_Ability_2_rgb_tw = ""
	--[+ Ability 2-1 - Duty and Honour +]--
	local ED_VET_Ability_2_1_rgb_tw = ""
	--[+ Ability 2-2 - Only In Death Does Duty End +]--
	local ED_VET_Ability_2_2_rgb_tw = ""
	--[+ Ability 2-3 - For the Emperor! +]--
	local ED_VET_Ability_2_3_rgb_tw = ""
	--[+ Ability 3 - Infiltrate +]--
	local ED_VET_Ability_3_rgb_tw = ""
	--[+ Ability 3-1 - Low Profile +]--
	local ED_VET_Ability_3_1_rgb_tw = ""
	--[+ Ability 3-2 - Overwatch +]--
	local ED_VET_Ability_3_2_rgb_tw = ""
	--[+ Ability 3-3 - Hunter's Resolve +]--
	local ED_VET_Ability_3_3_rgb_tw = ""
	--[+ Ability 3-4 - Surprise Attack +]--
	local ED_VET_Ability_3_4_rgb_tw = ""
	--[+ Ability 3-5 - Close Quarters Killzone +]--
	local ED_VET_Ability_3_5_rgb_tw = ""

--[+ +KEYSTONES+ +]--
	--[+ Keystone 1 - Marksman's Focus +]--
	local ED_VET_Keystone_1_rgb_tw = ""
	--[+ Keystone 1-1 - Chink in their Armour +]--
	local ED_VET_Keystone_1_1_rgb_tw = ""
	--[+ Keystone 1-2 - Tunnel Vision +]--
	local ED_VET_Keystone_1_2_rgb_tw = ""
	--[+ Keystone 1-3 - Long Range Assassin +]--
	-- local ED_VET_Keystone_1_rgb_tw = ""
	--[+ Keystone 1-4 - Camouflage +]--
	-- local ED_VET_Keystone_1_rgb_tw = ""
	--[+ Keystone 2 - Focus Target! +]--
	local ED_VET_Keystone_2_rgb_tw = ""
	--[+ Keystone 2-1 - Target Down! +]--
	local ED_VET_Keystone_2_1_rgb_tw = ""
	--[+ Keystone 2-2 - Redirect Fire! +]--
	local ED_VET_Keystone_2_2_rgb_tw = ""
	--[+ Keystone 2-3 - Focused Fire +]--
	-- local ED_VET_Keystone_2_3_rgb_tw = ""
	--[+ Keystone 3 - Weapons Specialist +]--
	local ED_VET_Keystone_3_rgb_tw = ""
	--[+ Keystone 3-1 - Always Prepared +]--
	local ED_VET_Keystone_3_1_rgb_tw = ""
	--[+ Keystone 3-2 - Invigorated +]--
	local ED_VET_Keystone_3_2_rgb_tw = ""
	--[+ Keystone 3-3 - On Your Toes +]--
	local ED_VET_Keystone_3_3_rgb_tw = ""
	--[+ Keystone 3-4 - Fleeting Fire +]--
	local ED_VET_Keystone_3_4_rgb_tw = ""
	--[+ Keystone 3-5 - Conditioning +]--
	local ED_VET_Keystone_3_5_rgb_tw = ""

--[+ +PASSIVES+ +]--
	--[+ Passive 1 - Longshot +]--
	local ED_VET_Passive_1_rgb_tw = ""
	--[+ Passive 2 - Close Order Drill +]--
	local ED_VET_Passive_2_rgb_tw = ""
	--[+ Passive 3 - One Motion +]--
	local ED_VET_Passive_3_rgb_tw = ""
	--[+ Passive 4 - Exhilarating Takedown +]--
	local ED_VET_Passive_4_rgb_tw = ""
	--[+ Passive 5 - Volley Adept +]--
	local ED_VET_Passive_5_rgb_tw = ""
	--[+ Passive 6 - Charismatic +]--
	local ED_VET_Passive_6_rgb_tw = ""
	--[+ Passive 7 - Confirmed Kill +]--
	local ED_VET_Passive_7_rgb_tw = ""
	--[+ Passive 8 - Tactical Reload +]--
	local ED_VET_Passive_8_rgb_tw = ""
	--[+ Passive 9 - Out for Blood +]--
	local ED_VET_Passive_9_rgb_tw = ""
	--[+ Passive 10 - Get Back in the Fight! +]--
	local ED_VET_Passive_10_rgb_tw = ""
	--[+ Passive 11 - Catch a Breath +]--
	local ED_VET_Passive_11_rgb_tw = ""
	--[+ Passive 12 - Grenade Tinkerer +]--
	local ED_VET_Passive_12_rgb_tw = ""
	--[+ Passive 13 - Covering Fire +]--
	local ED_VET_Passive_13_rgb_tw = ""
	--[+ Passive 14 - Serrated Blade +]--
	local ED_VET_Passive_14_rgb_tw = ""
	--[+ Passive 15 - Agile Engagement +]--
	local ED_VET_Passive_15_rgb_tw = ""
	--[+ Passive 16 - Kill Zone +]--
	local ED_VET_Passive_16_rgb_tw = ""
	--[+ Passive 17 - Opening Salvo +]--
	local ED_VET_Passive_17_rgb_tw = ""
	--[+ Passive 18 - Field Improvisation +]--
	local ED_VET_Passive_18_rgb_tw = ""
	--[+ Passive 19 - Twinned Blast +]--
	local ED_VET_Passive_19_rgb_tw = ""
	--[+ Passive 20 - Demolition Stockpile +]--
	local ED_VET_Passive_20_rgb_tw = ""
	--[+ Passive 21 - Grenadier +]--
	local ED_VET_Passive_21_rgb_tw = ""
	--[+ Passive 22 - Leave No One Behind +]--
	local ED_VET_Passive_22_rgb_tw = ""
	--[+ Passive 23 - Precision Strikes +]--
	local ED_VET_Passive_23_rgb_tw = ""
	--[+ Passive 24 - Determined +]--
	-- local ED_VET_Passive_24_rgb_tw = ""
	--[+ Passive 25 - Deadshot +]--
	local ED_VET_Passive_25_rgb_tw = ""
	--[+ Passive 26 - Born Leader +]--
	local ED_VET_Passive_26_rgb_tw = ""
	--[+ Passive 27 - Keep Their Heads Down! +]--
	local ED_VET_Passive_27_rgb_tw = ""
	--[+ Passive 28 - Reciprocity +]--
	local ED_VET_Passive_28_rgb_tw = ""
	--[+ Passive 29 - Duck and Dive +]--
	local ED_VET_Passive_29_rgb_tw = ""
	--[+ Passive 30 - Fully Loaded +]--
	local ED_VET_Passive_30_rgb_tw = ""
	--[+ Passive 31 - Tactical Awareness +]--
	local ED_VET_Passive_31_rgb_tw = ""
	--[+ Passive 32 - Desperado +]--
	local ED_VET_Passive_32_rgb_tw = ""
	--[+ Passive 33 - Shock Trooper +]--
	local ED_VET_Passive_33_rgb_tw = ""
	--[+ Passive 34 - Superiority Complex +]--
	local ED_VET_Passive_34_rgb_tw = ""
	--[+ Passive 35 - Iron Will +]--
	local ED_VET_Passive_35_rgb_tw = ""
	--[+ Passive 36 - Demolition Team +]--
	local ED_VET_Passive_36_rgb_tw = ""
	--[+ Passive 37 - Exploit Weakness +]--
	local ED_VET_Passive_37_rgb_tw = ""
	--[+ Passive 38 - Onslaught +]--
	local ED_VET_Passive_38_rgb_tw = ""
	--[+ Passive 39 - Trench Fighter Drill +]--
	local ED_VET_Passive_39_rgb_tw = ""
	--[+ Passive 40 - Skirmisher +]--
	local ED_VET_Passive_40_rgb_tw = ""
	--[+ Passive 41 - Competitive Urge +]--
	local ED_VET_Passive_41_rgb_tw = ""
	--[+ Passive 42 - Rending Strikes +]--
	local ED_VET_Passive_42_rgb_tw = ""
	--[+ Passive 43 - Bring it Down! +]--
	local ED_VET_Passive_43_rgb_tw = ""

--[+ ++OGRYN++ +]--
--[+ +BLITZ+ +]--
	--[+ Blitz 0 - Big Box of Hurt +]--
	local ED_OGR_Blitz_0_rgb_tw = ""
	--[+ Blitz 1 - Big Friendly Rock +]--
	local ED_OGR_Blitz_1_rgb_tw = ""
	--[+ Blitz 2 - Bombs Away! +]--
	local ED_OGR_Blitz_2_rgb_tw = ""
	--[+ Blitz 3 - Frag Bomb +]--
	local ED_OGR_Blitz_3_rgb_tw = ""
	--[+ Aura 0 - Intimidating Presence +]--
	local ED_OGR_Aura_0_rgb_tw = ""
	--[+ Aura 1 - Bonebreaker's Aura +]--
	local ED_OGR_Aura_1_rgb_tw = ""
	--[+ Aura 2 - Stay Close! +]--
	local ED_OGR_Aura_2_rgb_tw = ""
	--[+ Aura 3 - Coward Culling +]--
	local ED_OGR_Aura_3_rgb_tw = ""

--[+ +ABILITIES+ +]--
	--[+ Ability 0 - Bull Rush +]--
	local ED_OGR_Ability_0_rgb_tw = ""
	--[+ Ability 1 - Indomitable +]-- 
	local ED_OGR_Ability_1_rgb_tw = ""
	--[+ Ability 1-1 - Stomping Boots +]--
	local ED_OGR_Ability_1_1_rgb_tw = ""
	--[+ Ability 1-2 - Trample +]--
	local ED_OGR_Ability_1_2_rgb_tw = ""
	--[+ Ability 1-3 - Pulverise +]--
	local ED_OGR_Ability_1_3_rgb_tw = ""
	--[+ Ability 2 - Loyal Protector +]--
	local ED_OGR_Ability_2_rgb_tw = ""
	--[+ Ability 2-1 - Valuable Distraction +]--
	local ED_OGR_Ability_2_1_rgb_tw = ""
	--[+ Ability 2-2 - Go Again +]--
	local ED_OGR_Ability_2_2_rgb_tw = ""
	--[+ Ability 2-3 - Big Lungs +]--
	local ED_OGR_Ability_2_3_rgb_tw = ""
	--[+ Ability 3 - Point-Blank Barrage +]--
	local ED_OGR_Ability_3_rgb_tw = ""
	--[+ Ability 3-1 - Bullet Bravado +]--
	local ED_OGR_Ability_3_1_rgb_tw = ""
	--[+ Ability 3-2 - Hail of Fire +]--
	local ED_OGR_Ability_3_2_rgb_tw = ""
	--[+ Ability 3-3 - Light 'em Up +]--
	local ED_OGR_Ability_3_3_rgb_tw = ""

--[+ +KEYSTONES+ +]--
	--[+ Keystone 1 - Heavy Hitter +]--
	local ED_OGR_Keystone_1_rgb_tw = ""
	--[+ Keystone 1-1 - Just Getting Started +]--
	local ED_OGR_Keystone_1_1_rgb_tw = ""
	--[+ Keystone 1-2 - Unstoppable +]--
	local ED_OGR_Keystone_1_2_rgb_tw = ""
	--[+ Keystone 1-3 - Brutish Momentum +]--
	local ED_OGR_Keystone_1_3_rgb_tw = ""
	--[+ Keystone 2 - Feel No Pain +]--
	local ED_OGR_Keystone_2_rgb_tw = ""
	--[+ Keystone 2-1 - Pained Outburst +]--
	local ED_OGR_Keystone_2_1_rgb_tw = ""
	--[+ Keystone 2-2 - Strongest! +]--
	local ED_OGR_Keystone_2_2_rgb_tw = ""
	--[+ Keystone 2-3 - Toughest! +]--
	local ED_OGR_Keystone_2_3_rgb_tw = ""
	--[+ Keystone 3 - Burst Limiter Override +]--
	local ED_OGR_Keystone_3_rgb_tw = ""
	--[+ Keystone 3-1 - Maximum Firepower +]--
	local ED_OGR_Keystone_3_1_rgb_tw = ""
	--[+ Keystone 3-2 - Good Shootin' +]--
	local ED_OGR_Keystone_3_2_rgb_tw = ""
	--[+ Keystone 3-3 - More Burst Limiter Overrides! +]--
	-- local ED_OGR_Keystone_3_3_rgb_tw = ""

--[+ +PASSIVES+ +]--
	--[+ Passive 1 - Furious +]--
	local ED_OGR_Passive_1_rgb_tw = ""
	--[+ Passive 2 - Reloaded and Ready +]--
	local ED_OGR_Passive_2_rgb_tw = ""
	--[+ Passive 3 - The Best Defence +]--
	local ED_OGR_Passive_3_rgb_tw = ""
	--[+ Passive 4 - Heavyweight +]--
	local ED_OGR_Passive_4_rgb_tw = ""
	--[+ Passive 5 - Steady Grip +]--
	local ED_OGR_Passive_5_rgb_tw = ""
	--[+ Passive 6 - Smash 'Em! +]--
	local ED_OGR_Passive_6_rgb_tw = ""
	--[+ Passive 7 - Lynchpin +]--
	local ED_OGR_Passive_7_rgb_tw = ""
	--[+ Passive 8 - Slam +]--
	local ED_OGR_Passive_8_rgb_tw = ""
	--[+ Passive 9 - Soften Them Up +]--
	local ED_OGR_Passive_9_rgb_tw = ""
	--[+ Passive 10 - Crunch! +]--
	local ED_OGR_Passive_10_rgb_tw = ""
	--[+ Passive 11 - Batter +]--
	local ED_OGR_Passive_11_rgb_tw = ""
	--[+ Passive 12 - Pacemaker +]--
	local ED_OGR_Passive_12_rgb_tw = ""
	--[+ Passive 13 - Ammo Stash +]--
	-- local ED_OGR_Passive_13_rgb_tw = ""
	--[+ Passive 14 - Hard Knocks +]--
	local ED_OGR_Passive_14_rgb_tw = ""
	--[+ Passive 15 - Too Stubborn to Die +]--
	local ED_OGR_Passive_15_rgb_tw = ""
	--[+ Passive 16 - Delight in Destruction +]--
	local ED_OGR_Passive_16_rgb_tw = ""
	--[+ Passive 17 - Attention Seeker +]--
	local ED_OGR_Passive_17_rgb_tw = ""
	--[+ Passive 18 - Get Stuck In +]--
	local ED_OGR_Passive_18_rgb_tw = ""
	--[+ Passive 19 - Towering Presence +]--
	local ED_OGR_Passive_19_rgb_tw = ""
	--[+ Passive 20 - Unstoppable Momentum +]--
	local ED_OGR_Passive_20_rgb_tw = ""
	--[+ Passive 21 - No Stopping Me! +]--
	local ED_OGR_Passive_21_rgb_tw = ""
	--[+ Passive 22 - Dominate +]--
	local ED_OGR_Passive_22_rgb_tw = ""
	--[+ Passive 23 - Payback Time +]--
	local ED_OGR_Passive_23_rgb_tw = ""
	--[+ Passive 24 - Bruiser +]--
	local ED_OGR_Passive_24_rgb_tw = ""
	--[+ Passive 25 - Big Boom +]--
	local ED_OGR_Passive_25_rgb_tw = ""
	--[+ Passive 26 - Massacre +]--
	local ED_OGR_Passive_26_rgb_tw = ""
	--[+ Passive 27 - Implacable +]--
	local ED_OGR_Passive_27_rgb_tw = ""
	--[+ Passive 28 - No Pushover +]--
	local ED_OGR_Passive_28_rgb_tw = ""
	--[+ Passive 29 - Won't Give In +]--
	local ED_OGR_Passive_29_rgb_tw = ""
	--[+ Passive 30 - Mobile Emplacement +]--
	local ED_OGR_Passive_30_rgb_tw = ""
