...
local succss_dodge_means = "- [成功閃避]是只正確時機閃避或滑行，\n- 閃避已鎖定玩家的敵方攻擊。"
...
local z_ghost_hitnrun_n_stripp = "- 以下武器祝福可觸發天賦：\n- [幽靈]、[游擊]、[輕裝]。\n- 僅限遠程攻擊"
...
--[+ +BLITZ+ +]--
	...
	local ED_ZEA_Blitz_0_rgb_tw = iu_actit(table.concat({
		"\n",
		"- 爆炸引信時間："..COLORS_Numbers.n_1_5_rgb..COLORS_Numbers.n_second_rgb.."。",
		"- 爆炸半徑："..COLORS_Numbers.n_8_rgb..COLORS_Numbers.n_meter_rgb.."。",
		"",
		"- 電擊效果：",
		"-- 持續"..COLORS_Numbers.n_8_rgb..COLORS_Numbers.n_second_rgb.."，每"..COLORS_Numbers.n_055_rgb..COLORS_Numbers.n_second_rgb.."造成"..COLORS_KWords_tw.Dmg_rgb_tw.."和"..COLORS_KWords_tw.Stagger_rgb_tw.."。",
		"-- 除了變種人、隊長、雙子和巨獸。",
		"-- 無視堡壘的盾牌。",
		"-- 可在持續期間內刷新。",
	}, "\n"), enhdesc_col)
	...
	local ED_ZEA_Blitz_1_rgb_tw = iu_actit(table.concat({
		"\n",
		"- 爆炸引信時間："..COLORS_Numbers.n_1_5_rgb..COLORS_Numbers.n_second_rgb.."。",
		"- 爆炸半徑："..COLORS_Numbers.n_12_rgb..COLORS_Numbers.n_meter_rgb.."。",
		"- 電擊：",
		"-- 持續"..COLORS_Numbers.n_8_rgb..COLORS_Numbers.n_second_rgb.."，每"..COLORS_Numbers.n_055_rgb..COLORS_Numbers.n_second_rgb.."造成"..COLORS_KWords_tw.Dmg_rgb_tw.."和"..COLORS_KWords_tw.Stagger_rgb_tw.."。",
		"-- 除了變種人、隊長、雙子和巨獸。",
		"-- 無視堡壘的盾牌。",
	...
	local ED_ZEA_Blitz_2_rgb_tw = iu_actit(table.concat({
		...
		"- 爆炸引信時間："..COLORS_Numbers.n_1_7_rgb..COLORS_Numbers.n_second_rgb.."。",
		"- 火焰半徑："..COLORS_Numbers.n_5_rgb..COLORS_Numbers.n_meter_rgb.."。",
		"-- 持續"..COLORS_Numbers.n_15_rgb..COLORS_Numbers.n_second_rgb.."每"..COLORS_Numbers.n_0875_rgb..COLORS_Numbers.n_second_rgb.."造成"..COLORS_KWords_tw.Dmg_rgb_tw.."。",
		"-- 無視堡壘的盾牌、虛空護盾。",
		-- "---直接造成本體傷害。",
		"",
		"-- "..COLORS_KWords_tw.Burn_rgb_tw.."",
		"---對不屈敵人傷害極高",
		"---對無甲、感染者、狂熱者則是高傷害",
		"---對甲殼極低。",
	...
	local ED_ZEA_Blitz_3_rgb_tw = iu_actit(table.concat({
		...
		"- 基礎傷害："..COLORS_Numbers.n_585_rgb.."。",
		"- 飛刀沿弧線飛行。",
		"- 無距離衰減。",
		"- 低爆擊率 "..COLORS_Numbers.pc_5_rgb.."。",
		-- "-- 額外技巧(Finesse)在對無甲與防彈護甲時有加成。",
		"- "..COLORS_KWords_tw.Finesse_rgb_tw.."對無甲、防彈有加成。",
...
--[+ +KEYSTONES+ +]--
	...
	local ED_ZEA_Keystone_3_2_rgb_tw = iu_actit(table.concat({
		...
		"- 以下不會增加：",
		"- 砲手、收割者及狙擊手。",
		-- "(除了砲手、收割者及狙擊手)與特殊束縛攻擊(如瘟疫獵犬撲擊、陷阱兵投網、變種人衝撞抓取)時，額外獲得3層[命定審判]。",
		"",
		succss_dodge_means,
		"",
