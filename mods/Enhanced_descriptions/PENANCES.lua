...
--[+ ++PENANCES - ИСКУПЛЕНИЯ++ +]--
	...
	--[+ Russian +]--
	-- create_template("private_tag_ext_ru",
		-- {"loc_private_tag_name1"}, {"ru"},
			--loc_text("Закрытая игра")),
	--[+ Traditional Chinese +]--
	-- create_template("private_tag_ext_tw",
		-- {"loc_private_tag_name1"}, {"zh-tw"},
			--loc_text("私人遊戲")),

	--[+ Penance can only be completed in a private game +]-- Искупление может быть выполнено только в закрытой игре
	--[+ Russian +]--
	create_template("private_tag_ext_desc_ru",
		{"loc_private_tag_description"}, {"ru"},
			loc_text("Искупление может быть выполнено только в закрытой игре! Закрытую игру можно создать только в компании с минимум ещё одним игроком.")),
	--[+ Traditional Chinese +]--
	create_template("private_tag_ext_desc_tw",
		{"loc_private_tag_description"}, {"zh-tw"},
			loc_text("\n該苦修限定在私人遊戲完成！\n注意：私人遊戲需要另一名玩家共同組隊。")),

--[+ ++MISSIONS TYPES - ТИПЫ МИССИЙ++ +]--
	--[+ Russian +]--
	create_template("mission_type_1_ext_ru",
		{"loc_mission_type_01_name"}, {"ru"},
			loc_text("Налёт")),
	--[+ Traditional Chinese +]--
	create_template("mission_type_1_ext_tw",
		{"loc_mission_type_01_name"}, {"zh-tw"},
			loc_text("突襲")),

	--[+ Russian +]--
	-- create_template("mission_type_2_ext_ru",
		-- {"loc_mission_type_02_name"}, {"ru"},
			--loc_text("Убийство")),
	--[+ Traditional Chinese +]--
	-- create_template("mission_type_2_ext_tw",
		-- {"loc_mission_type_02_name"}, {"zh-tw"},
			--loc_text("刺殺")),

	--[+ Russian +]--
	-- create_template("mission_type_3_ext_ru",
		-- {"loc_mission_type_03_name"}, {"ru"},
			--loc_text("Расследование")),
	--[+ Traditional Chinese +]--
	-- create_template("mission_type_3_ext_tw",
		-- {"loc_mission_type_03_name"}, {"zh-tw"},
			--loc_text("調查")),

	--[+ Russian +]--
	-- create_template("mission_type_4_ext_ru",
		-- {"loc_mission_type_04_name"}, {"ru"},
			--loc_text("Диверсия")),
	--[+ Traditional Chinese +]--
	-- create_template("mission_type_4_ext_tw",
		-- {"loc_mission_type_04_name"}, {"zh-tw"},
			--loc_text("擾亂")),

	--[+ Russian +]--
	-- create_template("mission_type_5_ext_ru",
		-- {"loc_mission_type_05_name"}, {"ru"},
			--loc_text("Атака")),
	--[+ Traditional Chinese +]--
	-- create_template("mission_type_5_ext_tw",
		-- {"loc_mission_type_05_name"}, {"zh-tw"},
			--loc_text("打擊")),

	--[+ Russian +]--
	-- create_template("mission_type_6_ext_ru",
		-- {"loc_mission_type_06_name"}, {"ru"},
			--loc_text("Шпионаж")),
	--[+ Traditional Chinese +]--
	-- create_template("mission_type_6_ext_tw",
		-- {"loc_mission_type_06_name"}, {"zh-tw"},
			--loc_text("諜報")),

	--[+ Russian +]--
	create_template("mission_type_7_ext_ru",
		{"loc_mission_type_07_name"}, {"ru"},
			loc_text("Ремонт")),
	--[+ Traditional Chinese +]--
	create_template("mission_type_7_ext_tw",
		{"loc_mission_type_07_name"}, {"zh-tw"},
			loc_text("修復")),
...
--[+ ++ACCOUNT - УЧЁТНАЯ ЗАПИСЬ++ +]--
	...
	create_template("ach_acc_2_ext_desc_tw",
		{"loc_achievement_prologue_description"}, {"zh-tw"},
			loc_text("完成 "..COLORS_KW_Penances_tw.Prologue_p_rgb_tw.."。")),
	...
	create_template("ach_acc_4_ext_desc_tw",
		{"loc_achievement_unlock_gadgets_description"}, {"zh-tw"},
			loc_text("解鎖第一個 "..COLORS_KW_Penances_tw.Curio_p_rgb_tw.." 。")),
	...
	create_template("ach_acc_3_ext_desc_tw",
		{"loc_achievement_basic_training_description"}, {"zh-tw"},
			loc_text("完成 "..COLORS_KW_Penances_tw.Psykhanium_p_rgb_tw.." 的 "..COLORS_KW_Penances_tw.Base_tut_p_rgb_tw.."。")),
	...
	create_template("ach_acc_5_ext_desc_tw",
		{"loc_achievement_unlock_contracts_description"}, {"zh-tw"},
			loc_text("解鎖 "..COLORS_KW_Penances_tw.Sir_melk_p_rgb_tw.." 。")),
	...
	create_template("ach_acc_6_ext_desc_tw",
		{"loc_achievement_unlock_crafting_description"}, {"zh-tw"},
			loc_text("解鎖 "..COLORS_KW_Penances_tw.Omnissia_p_rgb_tw.." 。")),
...
--[+ СПОСОБНОСТИ - 技能 +]--
	...
	create_template("ach_class_vet_13_ext_desc_tw",
		{"loc_achievement_veteran_voice_of_command_toughness_given_description"}, {"zh-tw"},
			loc_text("使用 "..COLORS_KW_Penances_tw.Ability_p_rgb_tw.."『"..COLORS_KW_Penances_tw.voiceoc_rgb_tw.."』恢復自身 "..COLORS_Numbers.target_rgb.." 點 "..COLORS_KWords_tw.Toughness_rgb_tw.."。")),
	...
	create_template("ach_class_vet_13_ext_desc_tw",
		{"loc_achievement_veteran_team_damage_amplified_description"}, {"zh-tw"},
			loc_text("在 "..COLORS_KW_Penances_tw.Aura_p_rgb_tw.."『"..COLORS_KW_Penances_tw.firetim_rgb_tw.."』的影響下，擊殺 "..COLORS_Numbers.target_rgb.." 名敵人。\n"..COLORS_KW_Penances_tw.Aura_i_p_rgb_tw.." 的隊友擊殺也會計算。")),
	...
	create_template("ach_class_vet_8_ext_desc_tw",
		{"loc_achievement_veteran_krak_grenade_kills_description"}, {"zh-tw"},
			loc_text("使用 "..COLORS_KW_Penances_tw.Blitz_p_rgb_tw.."『"..COLORS_KW_Penances_tw.krak_gr_rgb_tw.."』擊殺 "..COLORS_Numbers.target_rgb.." 名護甲敵人。")),
	...
	create_template("ach_red_vet_3_ext_desc_tw",
		{"loc_achievement_veteran_2_unbounced_grenade_kills_description"}, {"zh-tw"},
			loc_text("使用 "..COLORS_KW_Penances_tw.Blitz_p_rgb_tw.."『"..COLORS_KW_Penances_tw.frag_gr_rgb_tw.."』擊殺 "..COLORS_Numbers.target_rgb.." 名敵人，且手榴彈在引爆前不得碰觸地面。" .. TALENTS_Enh_desc_penances_tw.ED_Long_bomb_rgb_tw)),
	...
	create_template("ach_red_vet_3_ext_desc_tw",
		{"loc_achievement_veteran_smoke_grenade_engulfed_description"}, {"zh-tw"},
			loc_text("使用 "..COLORS_KW_Penances_tw.Blitz_p_rgb_tw.."『"..COLORS_KW_Penances_tw.smok_gr_rgb_tw.."』使 "..COLORS_Numbers.target_rgb.." 名敵人陷入煙霧之中。")),
	...
	create_template("ach_red_vet_3_ext_desc_tw",
		{"loc_achievement_veteran_infiltrate_supress_description"}, {"zh-tw"},
			loc_text("使用 "..COLORS_KW_Penances_tw.Ability_p_rgb_tw.."『"..COLORS_KW_Penances_tw.infiltr_rgb_tw.."』壓制 "..COLORS_Numbers.target_rgb.." 名敵人。" .. TALENTS_Enh_desc_penances_tw.ED_Unseen_predator_rgb_tw)),
	...
	create_template("ach_red_vet_2_ext_desc_tw",
		{"loc_achievement_veteran_2_weakspot_hits_during_volley_fire_alternate_fire_description"}, {"zh-tw"},
			loc_text("於單次 "..COLORS_KW_Penances_tw.Ability_p_rgb_tw.."『"..COLORS_KW_Penances_tw.volley_fire_rgb_tw.."』或『"..COLORS_KW_Penances_tw.executioner_stance_rgb_tw.."』期間，\n使用瞄準射擊連續命中 "..COLORS_Numbers.target_rgb.." 名敵人的 "..COLORS_KWords_tw.Weakspot_rgb_tw.."，且不得中斷。" .. TALENTS_Enh_desc_penances_tw.ED_Headshot_rgb_tw)),
	...
	create_template("ach_class_vet_8_ext_desc_tw",
		{"loc_achievement_veteran_2_easy_2_description"}, {"zh-tw"},
			loc_text("透過 "..COLORS_KW_Penances_tw.Aura_p_rgb_tw.."『"..COLORS_KW_Penances_tw.scavenger_rgb_tw.."』或『"..COLORS_KW_Penances_tw.survivalist_rgb_tw.."』，\n為隊友恢復 "..COLORS_Numbers.target_rgb.." 發彈藥。")),
	...
	create_template("ach_class_vet_8_ext_desc_tw",
		{"loc_achievement_veteran_kills_with_improved_tag_description"}, {"zh-tw"},
			loc_text("擊殺 "..COLORS_Numbers.target_rgb.." 名被 "..COLORS_KW_Penances_tw.KeyStone_p_rgb_tw.."『"..COLORS_KW_Penances_tw.fcs_trg_rgb_tw.."』標記的敵人。")),
...
--[+ +СПОСОБНОСТИ+ +]--
	...
	create_template("ach_class_zea_7_ext_desc_tw",
		{"loc_achievement_zealot_elite_or_special_kills_with_blade_of_faith_description"}, {"zh-tw"},
			loc_text("使用 "..COLORS_KW_Penances_tw.Blitz_p_rgb_tw.."『"..COLORS_KW_Penances_tw.klinvery_rgb_tw.."』擊殺 "..COLORS_Numbers.target_rgb.." 名精英或特殊敵人。" .. TALENTS_Enh_desc_penances_tw.ED_Blessed_be_thine_aim_rgb_tw)),
	...
	create_template("ach_class_zea_8_ext_desc_tw",
		{"loc_achievement_zealot_aura_backstab_kills_while_alone_description"}, {"zh-tw"},
			loc_text("處於 "..COLORS_KW_Penances_tw.Aura_p_rgb_tw.."『"..COLORS_KWords_tw.Coherency_rgb_tw.."』狀態且未受到『"..COLORS_KW_Penances_tw.loner_rgb_tw.."』光環時，\n背刺擊殺 "..COLORS_Numbers.target_rgb.." 名遠程武器敵人。")),
	...
	create_template("ach_class_zea_8_ext_desc_tw",
		{"loc_achievement_zealot_team_toughness_restored_with_chorus_description"}, {"zh-tw"},
			loc_text("使用 "..COLORS_KW_Penances_tw.Ability_p_rgb_tw.."『"..COLORS_KW_Penances_tw.chorusosf_rgb_tw.."』，\n恢復隊友共計 "..COLORS_Numbers.target_rgb.." 點 "..COLORS_KWords_tw.Toughness_rgb_tw.."。")),
	...
	create_template("ach_class_zea_8_ext_desc_tw",
		{"loc_achievement_zealot_aura_corruption_healed_description"}, {"zh-tw"},
			loc_text("使用 "..COLORS_KW_Penances_tw.Aura_p_rgb_tw.."『"..COLORS_KW_Penances_tw.beaconop_rgb_tw.."』，並處於『"..COLORS_KWords_tw.Coherency_rgb_tw.."』狀態下，\n幫隊友恢復 "..COLORS_Numbers.target_rgb.." 點『"..COLORS_KWords_tw.Corruption_i_rgb_tw.."』。")),
	...
	create_template("ach_class_zea_8_	ext_desc_tw",
		{"loc_achievement_zealot_2_easy_2_description"}, {"zh-tw"},
			loc_text("使用 "..COLORS_KW_Penances_tw.Ability_p_rgb_tw.."『"..COLORS_KW_Penances_tw.chastise_wicked_rgb_tw.."』或『"..COLORS_KW_Penances_tw.fury_faithful_rgb_tw.."』恢復 "..COLORS_Numbers.target_rgb.." 點 "..COLORS_KWords_tw.Toughness_rgb_tw.."。")),
	...
	create_template("ach_class_zea_7_ext_desc_tw",
		{"loc_achievement_zealot_elite_or_special_kills_with_shroudfield_description"}, {"zh-tw"},
			loc_text("使用 "..COLORS_KW_Penances_tw.Ability_p_rgb_tw.."『"..COLORS_KW_Penances_tw.shroudf_rgb_tw.."』技能期間，\n以背刺擊殺 "..COLORS_Numbers.target_rgb.." 名精英或專家敵人。")),
	...
	create_template("ach_class_zea_7_ext_desc_tw",
		{"loc_achievement_zealot_kills_with_fire_grenade_description"}, {"zh-tw"},
			loc_text("使用 "..COLORS_KW_Penances_tw.Blitz_p_rgb_tw.."『"..COLORS_KW_Penances_tw.fire_gren_rgb_tw.."』燒死 "..COLORS_Numbers.target_rgb.." 名敵人。")),
	...
	create_template("ach_red_zea_2_ext_desc_tw",
		{"loc_achievement_zealot_2_stagger_sniper_with_grenade_distance_description"}, {"zh-tw"},
			loc_text("使用 "..COLORS_KW_Penances_tw.Blitz_p_rgb_tw.."『"..COLORS_KW_Penances_tw.shock_gren1_rgb_tw.."』或『"..COLORS_KW_Penances_tw.shock_gren0_rgb_tw.."』，\n擊中距離超過 "..COLORS_Numbers.target_rgb.." 公尺的敵方狙擊手。" .. TALENTS_Enh_desc_penances_tw.ED_Buying_time_rgb_tw)),
	...
	create_template("ach_class_zea_7_ext_desc_tw",
		{"loc_achievement_zealot_elite_or_special_kills_during_fanatic_rage_description"}, {"zh-tw"},
			loc_text("在『"..COLORS_KW_Penances_tw.fanrage_rgb_tw.."』發動期間，\n擊殺 "..COLORS_Numbers.target_rgb.." 名敵人，\n該效果來自 "..COLORS_KW_Penances_tw.KeyStone_p_rgb_tw.."『"..COLORS_KW_Penances_tw.blazingp_rgb_tw.."』。")),
	...
	create_template("ach_red_zea_3_ext_desc_tw",
		{"loc_achievement_zelot_2_kill_mutant_charger_with_melee_while_dashing_description"}, {"zh-tw"},
			loc_text("在 "..COLORS_KW_Penances_tw.Ability_p_rgb_tw.."『"..COLORS_KW_Penances_tw.chastise_wicked_rgb_tw.."』或『"..COLORS_KW_Penances_tw.fury_faithful_rgb_tw.."』發動時，\n以近戰攻擊擊殺一個變種人。")),
	...
	create_template("ach_class_zea_7_ext_desc_tw",
		{"loc_achievement_zealot_kills_during_movement_keystone_activated_description"}, {"zh-tw"},
			loc_text("擁有 "..COLORS_Numbers.n_15_rgb.." 層『"..COLORS_KW_Penances_tw.momentum_rgb_tw.."』時，擊殺 "..COLORS_Numbers.target_rgb.." 名精英或專家敵人，\n來源為"..COLORS_KW_Penances_tw.KeyStone_p_rgb_tw.."『"..COLORS_KW_Penances_tw.inexor_rgb_tw.."』。")),
...
--[+ +СПОСОБНОСТИ+ +]--
	...
	create_template("ach_class_psy_7_ext_desc_tw",
		{"loc_achievement_psyker_threshold_kills_reached_with_grenade_chain_description"}, {"zh-tw"},
			loc_text("擊殺 "..COLORS_Numbers.target_rgb.." 名被 "..COLORS_KW_Penances_tw.Blitz_p_rgb_tw.."『"..COLORS_KW_Penances_tw.smite_rgb_tw.."』"..COLORS_KWords_tw.Staggers_rgb_tw.." 的敵人。\n由隊友擊殺的也會計算。")),
	...
	create_template("ach_red_ogr_2_ext_desc_tw",
		{"loc_achievement_ogryn_2_bull_rushed_charging_ogryn_description"}, {"zh-tw"},
			loc_text("用 "..COLORS_KW_Penances_tw.Ability_p_rgb_tw.."『"..COLORS_KW_Penances_tw.bull_rush_rgb_tw.."』或『"..COLORS_KW_Penances_tw.bull_rush4_rgb_tw.."』，\n中斷瘟疫歐格林的衝鋒。" ..TALENTS_Enh_desc_penances_tw.ED_Im_in_charge_rgb_tw)),
