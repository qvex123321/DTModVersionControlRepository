...
--[+ +BLITZ+ +]--
	--[+ Blitz 0 - Brain Burst +]--
	local ED_PSY_Blitz_0_rgb_fr = ""
	--[+ Blitz 1 - Brain Rupture +]--
	local ED_PSY_Blitz_1_rgb_fr = ""
	--[+ Blitz 1-1 - Kinetic Resonance +]--
	local ED_PSY_Blitz_1_1_rgb_fr = ""
	--[+ Blitz 1-2 - Kinetic Flayer +]--
	local ED_PSY_Blitz_1_2_rgb_fr = ""
	--[+ Blitz 2 - Smite +]--
	local ED_PSY_Blitz_2_rgb_fr = ""
	--[+ Blitz 2-1 - Lightning Storm +]--
	local ED_PSY_Blitz_2_1_rgb_fr = ""
	--[+ Blitz 2-2 - Enfeeble +]--
	local ED_PSY_Blitz_2_2_rgb_fr = ""
	--[+ Blitz 2-3 - Charged Strike +]--
	local ED_PSY_Blitz_2_3_rgb_fr = ""
	--[+ Blitz 3 - Assail +]--
	local ED_PSY_Blitz_3_rgb_fr = ""
	--[+ Blitz 3-1 - Ethereal Shards +]--
	local ED_PSY_Blitz_3_1_rgb_fr = ""
	--[+ Blitz 3-2 - Quick Shards +]--
	local ED_PSY_Blitz_3_2_rgb_fr = ""

--[+ +AURA+ +]--
	--[+ Aura 0 - The Quickening +]--
	local ED_PSY_Aura_0_rgb_fr = ""
	--[+ Aura 1 - Kinetic Presence +]--
	local ED_PSY_Aura_1_rgb_fr = ""
	--[+ Aura 2 - Seer's Presence +]--
	local ED_PSY_Aura_2_rgb_fr = ""
	--[+ Aura 3 - Prescience +]--
	local ED_PSY_Aura_3_rgb_fr = ""

--[+ +ABILITIES+ +]--
	--[+ Ability 0 - Psykinetic's Wrath +]--
	local ED_PSY_Ability_0_rgb_fr = ""
	--[+ Ability 1 - Venting Shriek +]--
	local ED_PSY_Ability_1_rgb_fr = ""
	--[+ Ability 1-1 - Becalming Eruption +]--
	local ED_PSY_Ability_1_1_rgb_fr = ""
	--[+ Ability 1-2 - Warp Rupture +]--
	local ED_PSY_Ability_1_2_rgb_fr = ""
	--[+ Ability 1-3 - Warp Creeping Flames +]--
	local ED_PSY_Ability_1_3_rgb_fr = ""
	--[+ Ability 2 - Telekine Shield +]--
	local ED_PSY_Ability_2_rgb_fr = ""
	--[+ Ability 2-1 - Bolstered Shield +]--
	local ED_PSY_Ability_2_1_rgb_fr = ""
	--[+ Ability 2-2 - Enervating Threshold +]--
	local ED_PSY_Ability_2_2_rgb_fr = ""
	--[+ Ability 2-3 - Telekine Dome +]--
	local ED_PSY_Ability_2_3_rgb_fr = ""
	--[+ Ability 2-4 - Sanctuary +]--
	local ED_PSY_Ability_2_4_rgb_fr = ""
	--[+ Ability 3 - Scrier's Gaze +]--
	local ED_PSY_Ability_3_rgb_fr = ""
	-- [+ Ability 3-1 - Endurance +]--
	local ED_PSY_Ability_3_1_rgb_fr = ""
	-- [+ Ability 3-2 - Precognition +]--
	local ED_PSY_Ability_3_2_rgb_fr = ""
	--[+ Ability 3-3 - Warp Speed +]--
	local ED_PSY_Ability_3_3_rgb_fr = ""
	--[+ Ability 3-4 - Reality Anchor +]--
	local ED_PSY_Ability_3_4_rgb_fr = ""
	--[+ Ability 3-5 - Warp Unbound +]--
	local ED_PSY_Ability_3_5_rgb_fr = ""

--[+ +KEYSTONES+ +]--
	--[+ Keystone 1 - Warp Siphon +]--
	local ED_PSY_Keystone_1_rgb_fr = ""
	--[+ Keystone 1-1 - Inner Tranquility +]--
	local ED_PSY_Keystone_1_1_rgb_fr = ""
	--[+ Keystone 1-2 - Essence Harvest +]--
	local ED_PSY_Keystone_1_2_rgb_fr = ""
	--[+ Keystone 1-3 - Empyrean Empowerment +]--
	local ED_PSY_Keystone_1_3_rgb_fr = ""
	--[+ Keystone 1-4 - In Fire Reborn +]--
	local ED_PSY_Keystone_1_4_rgb_fr = ""
	--[+ Keystone 1-5 - Psychic Vampire +]--
	local ED_PSY_Keystone_1_5_rgb_fr = ""
	--[+ Keystone 1-6 - Warp Battery +]--
	local ED_PSY_Keystone_1_6_rgb_fr = ""
	--[+ Keystone 2 - Empowered Psionics - Empowered Brain Rupture +]--
	local ED_PSY_Keystone_2_0_1_rgb_fr = ""
	--[+ Keystone 2 - Empowered Psionics - Empowered Smite +]--
	local ED_PSY_Keystone_2_0_2_rgb_fr = ""
	--[+ Keystone 2 - Empowered Psionics - Empowered Assail +]--
	local ED_PSY_Keystone_2_0_3_rgb_fr = ""
	--[+ Keystone 2-1 - Bio-Lodestone +]--
	-- local ED_PSY_Keystone_2_1_rgb_fr = ""
	--[+ Keystone 2-2 - Psychic Leeching +]--
	local ED_PSY_Keystone_2_2_rgb_fr = ""
	--[+ Keystone 2-3 - Overpowering Souls +]--
	-- local ED_PSY_Keystone_2_3_rgb_fr = ""
	--[+ Keystone 2-4 - Charged Up +]--
	-- local ED_PSY_Keystone_2_4_rgb_fr = ""
	--[+ Keystone 3 - Disrupt Destiny +]--
	local ED_PSY_Keystone_3_rgb_fr = ""
	--[+ Keystone 3-1 - Perfectionism +]--
	-- local ED_PSY_Keystone_3_1_rgb_fr = ""
	--[+ Keystone 3-2 - Purloin Providence +]--
	local ED_PSY_Keystone_3_2_rgb_fr = ""
	--[+ Keystone 3-3 - Lingering Influence +]--
	-- local ED_PSY_Keystone_3_3_rgb_fr = ""
	--[+ Keystone 3-4 - Cruel Fortune +]--
	local ED_PSY_Keystone_3_4_rgb_fr = ""

--[+ +PASSIVES+ +]--
	--[+ Passive 1 - Soulstealer +]--
	local ED_PSY_Passive_1_rgb_fr = ""
	--[+ Passive 2 - Mettle +]--
	local ED_PSY_Passive_2_rgb_fr = ""
	--[+ Passive 3 - Quietude +]--
	local ED_PSY_Passive_3_rgb_fr = ""
	--[+ Passive 4 - Warp Expenditure +]--
	local ED_PSY_Passive_4_rgb_fr = ""
	--[+ Passive 5 - Perilous Combustion +]--
	local ED_PSY_Passive_5_rgb_fr = ""
	--[+ Passive 6 - Perfect Timing +]--
	local ED_PSY_Passive_6_rgb_fr = ""
	--[+ Passive 7 - Battle Meditation +]--
	local ED_PSY_Passive_7_rgb_fr = ""
	--[+ Passive 8 - Wildfire +]--
	local ED_PSY_Passive_8_rgb_fr = ""
	--[+ Passive 9 - Psykinetic's Aura +]--
	local ED_PSY_Passive_9_rgb_fr = ""
	--[+ Passive 10 - Mind in Motion +]--
	local ED_PSY_Passive_10_rgb_fr = ""
	--[+ Passive 11 - Malefic Momentum +]--
	local ED_PSY_Passive_11_rgb_fr = ""
	--[+ Passive 12 - Channeled Force +]--
	local ED_PSY_Passive_12_rgb_fr = ""
	--[+ Passive 13 - Perilous Assault +]--
	local ED_PSY_Passive_13_rgb_fr = ""
	--[+ Passive 14 - Lightning Speed +]--
	local ED_PSY_Passive_14_rgb_fr = ""
	--[+ Passive 15 - Souldrinker +]--
	local ED_PSY_Passive_15_rgb_fr = ""
	--[+ Passive 16 - Empyric Shock +]--
	local ED_PSY_Passive_16_rgb_fr = ""
	--[+ Passive 17 - By Crack of Bone +]--
	local ED_PSY_Passive_17_rgb_fr = ""
	--[+ Passive 18 - Warp Splitting +]--
	local ED_PSY_Passive_18_rgb_fr = ""
	--[+ Passive 19 - Unlucky for Some +]--
	local ED_PSY_Passive_19_rgb_fr = ""
	--[+ Passive 20 - One with the Warp +]--
	local ED_PSY_Passive_20_rgb_fr = ""
	--[+ Passive 21 - Empathic Evasion +]--
	local ED_PSY_Passive_21_rgb_fr = ""
	--[+ Passive 22 - Anticipation +]--
	local ED_PSY_Passive_22_rgb_fr = ""
	--[+ Passive 23 - Solidity +]--
	local ED_PSY_Passive_23_rgb_fr = ""
	--[+ Passive 24 - Puppet Master +]--
	local ED_PSY_Passive_24_rgb_fr = ""
	--[+ Passive 25 - Warp Rider +]--
	local ED_PSY_Passive_25_rgb_fr = ""
	--[+ Passive 26 - Crystalline Will +]--
	local ED_PSY_Passive_26_rgb_fr = ""
	--[+ Passive 27 - Kinetic Deflection +]--
	local ED_PSY_Passive_27_rgb_fr = ""
	--[+ Passive 28 - Tranquility Through Slaughter +]--
	local ED_PSY_Passive_28_rgb_fr = ""
	--[+ Passive 29 - Empyric Resolve +]--
	local ED_PSY_Passive_29_rgb_fr = ""
	--[+ Passive 30 - Penetration of the Soul +]--
	local ED_PSY_Passive_30_rgb_fr = ""
	--[+ Passive 31 - True Aim +]--
	local ED_PSY_Passive_31_rgb_fr = ""
	--[+ Passive 32 - Surety of Arms +]--
	-- 
	local ED_PSY_Passive_32_rgb_fr = ""

--[+ ++ZEALOT++ +]--
--[+ +BLITZ+ +]--
	--[+ Blitz 0 - Stun Grenade +]--
	local ED_ZEA_Blitz_0_rgb_fr = ""
	
	--[+ Blitz 1 - Stunstorm Grenade +]--
	local ED_ZEA_Blitz_1_rgb_fr = ""
	
	--[+ Blitz 2 - Immolation Grenade +]--
	local ED_ZEA_Blitz_2_rgb_fr = ""
	--[+ Blitz 3 - Blades of Faith +]--
	local ED_ZEA_Blitz_3_rgb_fr = ""

--[+ +AURA+ +]--
	--[+ Aura 0 - The Emperors's Will +]--
	--[+ Aura 1 - Benediction +]--
	local ED_ZEA_Aura_0_n_1_rgb_fr = ""
	--[+ Aura 2 - Beacon of Purity +]--
	local ED_ZEA_Aura_2_rgb_fr = ""
	--[+ Aura 3 - Loner +]--
	local ED_ZEA_Aura_3_rgb_fr = ""
	--[+ Ability 0 - Chastise the Wicked +]--
	local ED_ZEA_Ability_0_rgb_fr = ""
	--[+ Ability 1 - Fury of the Faithful +]--
	local ED_ZEA_Ability_1_rgb_fr = ""
	--[+ Ability 1-1 - Redoubled Zeal +]--
	local ED_ZEA_Ability_1_1_rgb_fr = ""
	--[+ Ability 1-2 - Invocation of Death +]--
	local ED_ZEA_Ability_1_2_rgb_fr = ""
	--[+ Ability 2 - Chorus of Spiritual Fortitude +]--
	local ED_ZEA_Ability_2_rgb_fr = ""
	--[+ Ability 2-1 - Holy Cause +]--
	local ED_ZEA_Ability_2_1_rgb_fr = ""
	--[+ Ability 2-2 - Banishing Light +]--
	local ED_ZEA_Ability_2_2_rgb_fr = ""
	--[+ Ability 2-3 - Ecclesiarch's Call +]--
	local ED_ZEA_Ability_2_3_rgb_fr = ""
	--[+ Ability 2-4 - Martyr's Purpose +]--
	local ED_ZEA_Ability_2_4_rgb_fr = ""
	--[+ Ability 3 - Shroudfield +]--
	local ED_ZEA_Ability_3_rgb_fr = ""
	--[+ Ability 3-1 - Master-Crafted Shroudfield +]--
	-- local ED_ZEA_Ability_3_1_rgb_fr = ""
	--[+ Ability 3-2 - Perfectionist +]--
	local ED_ZEA_Ability_3_2_rgb_fr = ""
	--[+ Ability 3-3 - Invigorating Revelation +]--
	local ED_ZEA_Ability_3_3_rgb_fr = ""
	--[+ Ability 3-4 - Pious Cut-Throat +]--
	local ED_ZEA_Ability_3_4_rgb_fr = ""

--[+ +KEYSTONES+ +]--
	--[+ Keystone 1 - Blazing Piety +]--
	local ED_ZEA_Keystone_1_rgb_fr = ""
	--[+ Keystone 1-1 - Stalwart +]--
	local ED_ZEA_Keystone_1_1_rgb_fr = ""
	--[+ Keystone 1-2 - Fury Rising +]--
	local ED_ZEA_Keystone_1_2_rgb_fr = ""
	--[+ Keystone 1-3 - Infectious Zeal +]--
	local ED_ZEA_Keystone_1_3_rgb_fr = ""
	--[+ Keystone 1-4 - Righteous Warrior +]--
	local ED_ZEA_Keystone_1_4_rgb_fr = ""
	--[+ Keystone 2 - Martyrdom +]--
	local ED_ZEA_Keystone_2_rgb_fr = ""
	--[+ Keystone 2-1 - I Shall Not Fall +]--
	local ED_ZEA_Keystone_2_1_rgb_fr = ""
	--[+ Keystone 2-2 - Maniac +]--
	local ED_ZEA_Keystone_2_2_rgb_fr = ""
	--[+ Keystone 3 - Inexorable Judgement +]--
	local ED_ZEA_Keystone_3_rgb_fr = ""
	--[+ Keystone 3-1 - Retributor's Stance +]--
	local ED_ZEA_Keystone_3_1_rgb_fr = ""
	--[+ Keystone 3-2 - Inebriate's Poise +]--
	local ED_ZEA_Keystone_3_2_rgb_fr = ""

--[+ +PASSIVES+ +]--
	--[+ Passive 1 - Disdain +]--
	local ED_ZEA_Passive_1_rgb_fr = ""
	--[+ Passive 2 - Backstabber +]--
	local ED_ZEA_Passive_2_rgb_fr = ""
	--[+ Passive 3 - Anoint in Blood +]--
	local ED_ZEA_Passive_3_rgb_fr = ""
	--[+ Passive 4 - Scourge +]--
	local ED_ZEA_Passive_4_rgb_fr = ""
	--[+ Passive 5 - Enemies Within, Enemies Without +]--
	local ED_ZEA_Passive_5_rgb_fr = ""
	--[+ Passive 6 - Fortitude in Fellowship +]--
	local ED_ZEA_Passive_6_rgb_fr = ""
	--[+ Passive 7 - Purge the Unclean +]--
	local ED_ZEA_Passive_7_rgb_fr = ""
	--[+ Passive 8 - Blood Redemption +]--
	local ED_ZEA_Passive_8_rgb_fr = ""
	--[+ Passive 9 - Bleed for the Emperor +]--
	local ED_ZEA_Passive_9_rgb_fr = ""
	--[+ Passive 10 - Vicious Offering +]--
	local ED_ZEA_Passive_10_rgb_fr = ""
	--[+ Passive 11 - The Voice of Terra +]--
	local ED_ZEA_Passive_11_rgb_fr = ""
	--[+ Passive 12 - Restoring Faith +]--
	local ED_ZEA_Passive_12_rgb_fr = ""
	--[+ Passive 13 - Second Wind +]--
	local ED_ZEA_Passive_13_rgb_fr = ""
	--[+ Passive 14 - Enduring Faith +]--
	local ED_ZEA_Passive_14_rgb_fr = ""
	--[+ Passive 15 - The Emperor's Bullet +]--
	local ED_ZEA_Passive_15_rgb_fr = ""
	--[+ Passive 16 - Dance of Death +]--
	local ED_ZEA_Passive_16_rgb_fr = ""
	--[+ Passive 17 - Duellist +]--
	local ED_ZEA_Passive_17_rgb_fr = ""
	--[+ Passive 18 - Until Death +]--
	local ED_ZEA_Passive_18_rgb_fr = ""
	--[+ Passive 19 - Unremitting +]--
	local ED_ZEA_Passive_19_rgb_fr = ""
	--[+ Passive 20 - Shield of Contempt +]--
	local ED_ZEA_Passive_20_rgb_fr = ""
	--[+ Passive 21 - Thy Wrath be Swift +]--
	local ED_ZEA_Passive_21_rgb_fr = ""
	--[+ Passive 22 - Good Balance +]--
	local ED_ZEA_Passive_22_rgb_fr = ""
	--[+ Passive 23 - Desperation +]--
	local ED_ZEA_Passive_23_rgb_fr = ""
	--[+ Passive 24 - Holy Revenant +]--
	local ED_ZEA_Passive_24_rgb_fr = ""
	--[+ Passive 25 - Sainted Gunslinger +]--
	local ED_ZEA_Passive_25_rgb_fr = ""
	--[+ Passive 26 - Hammer of Faith +]--
	local ED_ZEA_Passive_26_rgb_fr = ""
	--[+ Passive 27 - Grievous Wounds +]--
	local ED_ZEA_Passive_27_rgb_fr = ""
	--[+ Passive 28 - Ambuscade +]--
	local ED_ZEA_Passive_28_rgb_fr = ""
	--[+ Passive 29 - Punishment +]--
	local ED_ZEA_Passive_29_rgb_fr = ""
	--[+ Passive 30 - Faithful Frenzy +]--
	local ED_ZEA_Passive_30_rgb_fr = ""
	--[+ Passive 31 - Sustained Assault +]--
	local ED_ZEA_Passive_31_rgb_fr = ""
	--[+ Passive 32 - The Master's Retribution +]--
	local ED_ZEA_Passive_32_rgb_fr = ""
	--[+ Passive 33 - Faith's Fortitude +]--
	local ED_ZEA_Passive_33_rgb_fr = ""
	--[+ Passive 34 - Swift Certainty +]--
	local ED_ZEA_Passive_34_rgb_fr = ""
