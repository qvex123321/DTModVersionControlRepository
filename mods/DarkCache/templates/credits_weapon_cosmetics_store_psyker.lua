return {
	key = "credits_weapon_cosmetics_store_psyker",
	refresh_on_expiry = true,
	setting_id = "cache_item_credits_weapon_cosmetics_store",
	hooks = {
		{ obj = "Store", method = "get_psyker_credits_weapon_cosmetics_store" }
	},
	cb_fetch = function()
		return Managers.backend.interfaces.store:get_psyker_credits_weapon_cosmetics_store(
