return {
	key = "credits_cosmetics_store_ogryn",
	refresh_on_expiry = true,
	setting_id = "cache_item_credits_cosmetics_store",
	hooks = {
		{ obj = "Store", method = "get_ogryn_credits_cosmetics_store" }
	},
	cb_fetch = function()
		return Managers.backend.interfaces.store:get_ogryn_credits_cosmetics_store(
