return {
	key = "credits_weapon_cosmetics_store_veteran",
	refresh_on_expiry = true,
	setting_id = "cache_item_credits_weapon_cosmetics_store",
	hooks = {
		{ obj = "Store", method = "get_veteran_credits_weapon_cosmetics_store" }
	},
	cb_fetch = function()
		return Managers.backend.interfaces.store:get_veteran_credits_weapon_cosmetics_store(
