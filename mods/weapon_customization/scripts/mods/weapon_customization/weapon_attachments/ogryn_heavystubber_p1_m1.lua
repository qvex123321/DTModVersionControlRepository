...
local functions = {
    ...
    barrel_models = function(parent, angle, move, remove)
        ...
        return {
            ...
            barrel_04 =      {model = _item_ranged.."/barrels/stubgun_heavy_ogryn_barrel_04", type = "barrel", parent = tv(parent, 5), angle = a, move = m, remove = r},
            barrel_05 =      {model = _item_ranged.."/barrels/stubgun_heavy_ogryn_barrel_05", type = "barrel", parent = tv(parent, 6), angle = a, move = m, remove = r},
        }
    end,
...
return table.combine(
    functions,
    {
        ...
        models = table.combine( -- Done 5.9.2023
            ...
            _common.trinket_hook_models("grip", .3, vector3_box(-.6, -5, .1), vector3_box(0, -.1, -.1))
        ),
